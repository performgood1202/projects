    ...
    <!-- Page Heading -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Edit technicians</h6>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <form class="user" method="POST"  action="{{ route('updateTechnician',array('id'=>$id)) }}">
                                            @csrf
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    <input id="name" type="text" class="form-control form-control-user @error('name') is-invalid @enderror" name="name" value="{{ $technician['name'] }}" required autocomplete="name" autofocus placeholder="Name">
                                                ...
                                                <div class="col-sm-6">
                                                    <input id="email" type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email" value="{{$technician['email']}}" required autocomplete="email"  placeholder="Email">
